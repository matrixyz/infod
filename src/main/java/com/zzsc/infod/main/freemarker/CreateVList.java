...
public class CreateVList extends FmkBase {
    ...
    public void process(String tableName , List<BeanCommon> ls ) throws IOException, TemplateException {
        ...
        //3.将模版进行指定文件的输出
        String outPath=System.getProperty("user.dir")+"/src/main/resources"+"/"+OUT_PUT_PATH+"/"+className+"-list.html";
        write(root,outPath);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateVList hfm = new CreateVList();
        hfm.init(args[0]);
        hfm.preparedData();
