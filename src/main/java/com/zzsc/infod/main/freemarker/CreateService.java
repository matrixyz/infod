...
public class CreateService extends FmkBase {
    ...
    //3.将模版进行指定文件的输出
    String outPath=System.getProperty("user.dir")+"/src/main/java"+"/"+OUT_PUT_PATH+"/"+className+"Service.java";
    write(root,outPath);

}
    //重写父类的方法
    public void init(){
        OUT_PUT_PATH="com/zzsc/infod/service";
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateService hfm = new CreateService();
        hfm.init(args[0]);
         hfm.preparedData();
