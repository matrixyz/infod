...
public interface SomeXlsAnalyseServiceExcel {
    ...
    Map<String,SomeXlsDto> getSomeXlsFromRow(String type, File[] files,String[] cols, HttpSession session) throws Exception;

    Map<String, SomeXlsDto> initByPath(String path, String type, String[] cols, HttpSession session) throws Exception;
